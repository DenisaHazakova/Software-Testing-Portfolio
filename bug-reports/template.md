...
| Steps to reproduce | Exact steps to trigger the bug | _ Navigate to https://app.example.com/login |
_ Enter valid credentials (username: testuser, password: Test@123) |
_ Click the Submit button |
_ Observe the page behaviour |
